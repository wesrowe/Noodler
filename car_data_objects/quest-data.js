	...
	"styleHolder": [
		{
			...
			"attributeGroups": {
				"MAIN": {
					...
					"attributes": {
						...
						"NAME": {
							"id": 1,
							"name": "NAME",
							"value": "SL 4dr Minivan (3.5L 6cyl CVT)"
						},
						"USE_IN_NEW": {
							"id": 10,
							"name": "USE_IN_NEW",
				...
				"AIR_CONDITIONING": {
					...
					"attributes": {
						"FRONT_AIR_CONDITIONING_ZONES": {
							"id": 85,
							"name": "FRONT_AIR_CONDITIONING_ZONES",
							"value": "dual"
						},
				...
				"CRASH_TEST_RATINGS": {
					...
					"attributes": {
						...
						"IIHS_REAR_CRASH_PROTECTION/HEAD_RESTRAINT_RATINGS": {
							"id": 136,
							"name": "IIHS_REAR_CRASH_PROTECTION/HEAD_RESTRAINT_RATINGS",
							"value": "Good"
						},
				...
				"MIRRORS": {
					...
					"attributes": {
						...
						"DRIVER_SIDE_MIRROR_ADJUSTMENT": {
							"id": 256,
							"name": "DRIVER_SIDE_MIRROR_ADJUSTMENT",
							"value": "power"
						},
						"HEATED_PASSENGER_SIDE_MIRROR": {
							"id": 259,
				...
				"STEERING_WHEEL": {
					...
					"attributes": {
						"STEERING_WHEEL_ADJUSTMENTS": {
							"id": 353,
							"name": "STEERING_WHEEL_ADJUSTMENTS",
							"value": "tilt and telescopic"
						},
						"CRUISE_CONTROLS_ON_STEERING_WHEEL": {
							"id": 350,
				...
				"2ND_ROW_SEATS": {
					...
					"attributes": {
						...
						"ADJUSTABLE_2ND_ROW_HEADRESTS": {
							"id": 48,
							"name": "ADJUSTABLE_2ND_ROW_HEADRESTS",
				...
				"SEATBELTS": {
					...
					"attributes": {
						...
						"3RD_ROW_CENTER_SEATBELT": {
							"id": 315,
							"name": "3RD_ROW_CENTER_SEATBELT",
							"value": "3-point belt"
						},
				...
				"SUSPENSION": {
					...
					"name": "SUSPENSION",
					"attributes": {
						"FRONT_SUSPENSION_CLASSIFICATION": {
							"id": 385,
							"name": "FRONT_SUSPENSION_CLASSIFICATION",
							"value": "independent"
						},
						...
						"REAR_SUSPENSION_CLASSIFICATION": {
							"id": 392,
							"name": "REAR_SUSPENSION_CLASSIFICATION",
							"value": "independent"
						},
						"FRONT_STABILIZER_BAR": {
							"id": 384,
							"name": "FRONT_STABILIZER_BAR",
				...
				"1ST_ROW_SEATS": {
					...
					"attributes": {
						...
						"NUMBER_OF_1ST_ROW_HEADRESTS": {
							"id": 44,
							"name": "NUMBER_OF_1ST_ROW_HEADRESTS",
							"value": "2"
						}
					}
				},
				...
				"TRACTION/STABILITY_CONTROL": {
					"id": 45,
					"name": "TRACTION/STABILITY_CONTROL",
					"attributes": {
						"STABILITY_CONTROL": {
							"id": 394,
				...
				"NCI_STANDARD_FACET": {
					...
					"attributes": {
						...
						"SEAT_MATERIAL:_LEATHER": {
							"id": 0,
							"name": "SEAT_MATERIAL:_LEATHER",
							"value": "200437068"
						},
				...
				"STORAGE": {
					...
					"attributes": {
						"1ST_ROW_CENTER_CONSOLE": {
							...
							"value": "front and rear console with storage"
						},
						"CARGO_TIE_DOWNS": {
							"id": 360,
							"name": "CARGO_TIE_DOWNS",
						...
						"CUPHOLDERS_LOCATION": {
							"id": 363,
							"name": "CUPHOLDERS_LOCATION",
							"value": "front, rear and 3rd row"
						},
				...
				"DOORS": {
					...
					"attributes": {
						"SOFT_CLOSE_DOORS": {
							"id": 155,
							"name": "SOFT_CLOSE_DOORS",
							"value": "soft close rear liftgate"
						},
						"REAR_DOOR_TYPE": {
							"id": 153,
							"name": "REAR_DOOR_TYPE",
				...
				"AIRBAGS": {
					...
					"attributes": {
						"HEAD_AIRBAGS": {
							"id": 91,
							"name": "HEAD_AIRBAGS",
							"value": "front, rear and third row"
						},
						"PASSENGER_AIRBAG_DEACTIVATION": {
							"id": 95,
				...
				"3RD_ROW_SEATS": {
					...
					"attributes": {
						"FOLDING_3RD_ROW": {
							"id": 65,
							"name": "FOLDING_3RD_ROW",
							"value": "manual folding split-bench"
						},
						"3RD_ROW_SEAT_TYPE": {
							"id": 68,
				...
				"SEATING_CONFIGURATION": {
					"id": 36,
					"name": "SEATING_CONFIGURATION",
					"attributes": {
						"1ST_ROW_SEATING_CAPACITY": {
							"id": 320,
							"name": "1ST_ROW_SEATING_CAPACITY",
							"value": "2"
						},
				...
				"DRIVER_SEAT": {
					...
					"attributes": {
						...
						"DRIVER_SEAT_ADJUSTABLE_LUMBAR": {
							"id": 163,
							"name": "DRIVER_SEAT_ADJUSTABLE_LUMBAR",
				...
				"WINDOWS": {
					...
					"name": "WINDOWS",
					"attributes": {
						"REMOTE_WINDOW_OPERATION": {
							"id": 433,
							"name": "REMOTE_WINDOW_OPERATION",
							"value": "remote window operation"
						},
						"PRIVACY_GLASS": {
							"id": 428,
							"name": "PRIVACY_GLASS",
						...
						"SPEED_SENSITIVE_FRONT_WIPERS": {
							"id": 421,
							"name": "SPEED_SENSITIVE_FRONT_WIPERS",
							"value": "speed sensitive"
						},
						"ONE_TOUCH_WINDOWS": {
							"id": 425,
						...
						"INTERMITTENT_FRONT_WIPERS": {
							"id": 419,
							"name": "INTERMITTENT_FRONT_WIPERS",
				...
				"NCI_OPTIONAL_FACET": {
					...
					"attributes": {
						"IPOD_INTEGRATION": {
							"id": 0,
							"name": "IPOD_INTEGRATION",
							"value": "200437087"
						},
						"CD_MP3_PLAYBACK": {
							"id": 0,
							"name": "CD_MP3_PLAYBACK",
							"value": "200437087,200437088"
						},
						"CARGO_NET": {
							"id": 0,
							"name": "CARGO_NET",
						...
						"SUNROOF:_POWER_GLASS": {
							"id": 0,
							"name": "SUNROOF:_POWER_GLASS",
							"value": "200437089"
						},
						...
						"ONE_TOUCH_POWER_SUNROOF": {
							"id": 0,
							"name": "ONE_TOUCH_POWER_SUNROOF",
							"value": "200437089"
						},
						"DVD_PLAYER": {
							"id": 0,
				...
				"TMVU_FEATURE": {
					...
					"attributes": {
						...
						"TMVU_FEATURE_DESCRIPTION_3710000003": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3710000003",
							"value": "Automatic On/Off Headlights"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_3710000007": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3710000007",
							"value": "Front Fog/Driving Lights"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_2610000003": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_2610000003",
							"value": "Heated Passenger Seat"
						},
						"TMVU_FEATURE_DESCRIPTION_2610000004": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_2610000004",
							"value": "Heated Driver's Seat"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_2510000019": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_2510000019",
							"value": "Leather Seating"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_3310000044": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3310000044",
							"value": "Simulated Wood Door Trim"
						},
						"TMVU_FEATURE_DESCRIPTION_3310000043": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3310000043",
							"value": "Simulated Wood Dash Trim"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_1910000006": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_1910000006",
							"value": "Rear Ventilated Disc Brakes"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_2410000000": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_2410000000",
							"value": "Anti-Theft Alarm System"
						},
						"TMVU_FEATURE_DESCRIPTION_4610000107": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_4610000107",
							"value": "Front and Rear Console with Storage"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_4310000008": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_4310000008",
							"value": "Power Liftgate Rear Door"
						},
						"TMVU_FEATURE_DESCRIPTION_3310000038": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3310000038",
							"value": "Leather Steering Wheel Trim"
						},
						"TMVU_FEATURE_DESCRIPTION_3310000037": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3310000037",
							"value": "Leather Shift Knob Trim"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_3210000042": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3210000042",
							"value": "Variable Power Steering"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_1020000006": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_1020000006",
						...
						"TMVU_FEATURE_DESCRIPTION_3510000016": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3510000016",
							"value": "Remote Window Operation"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_3510000017": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_3510000017",
							"value": "Speed Sensing Windshield Wipers"
						},
						...
						"TMVU_FEATURE_DESCRIPTION_4020000043": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_4020000043",
						...
						"TMVU_FEATURE_DESCRIPTION_1501000053": {
							"id": 0,
							"name": "TMVU_FEATURE_DESCRIPTION_1501000053",
							"value": "18 Inch Alloy Wheels"
						},
				...
				"SPARE_TIRE/WHEEL": {
					"id": 38,
					"name": "SPARE_TIRE/WHEEL",
					"attributes": {
						"SPARE_WHEEL_RIM_TYPE": {
							"id": 332,
							"name": "SPARE_WHEEL_RIM_TYPE",
							"value": "steel"
						},
						"SPARE_TIRE_MOUNT_LOCATION": {
							"id": 331,
							"name": "SPARE_TIRE_MOUNT_LOCATION",
							"value": "underbody"
						},
						"SPARE_TIRE_SIZE": {
							"id": 333,
							"name": "SPARE_TIRE_SIZE",
							"value": "temporary"
						}
					}
				},
				...
				"SECURITY": {
					...
					"attributes": {
						...
						"2_STAGE_UNLOCKING": {
							"id": 325,
							"name": "2_STAGE_UNLOCKING",
							"value": "remote 2-stage unlocking"
						},
			...
			"subModels": [
				{
					...
					"submodelNewDefaultStyle": {
						"link": "/api/vehicle/style/200437067"
					},
					"submodelUsedDefaultStyle": {
						"link": "/api/vehicle/style/200437068"
					}
				}
			],
			"name": "SL 4dr Minivan (3.5L 6cyl CVT)",
			"niceName": "sl4drminivan35l6cylcvt",
